...
abstract: This paper provides a gentle introduction into causal inference focusing on structural causal models. 
---
...
Probability theory deals with outcomes given a specific underlying data generating process. 

## SEM and Structural Causal Model 
...
The second section discusses the hierachy of causation. 
The third section dicusses causal graphs. 
The fourth 
...
Differential equations can describe a dynamic system accounting with time considerations.

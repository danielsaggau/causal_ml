...
abstract: This paper provides a gentle introduction into causal inference focusing on structural causal models. Structural Causal Models are abstractions of underlying physical mechanisms. SCMs are used for causal inference. This paper briefly introduces the role of time in causality. I will use a two and three variable model to illustrate underlying assumptions of structural causal models.
---

...
- Assignments ':=' (non-symmetric) instead of algebraic equation '=' (symmetry)
- As mentioned, we define variables as functions e.g. $A=f_A(B,U_A)$.
**Error in Regression:** Omittable outside factor 
**Error in SCM/SEM:** Latent (influential) factor that is pivotal for the model 
...
- SCM as simulator for causal modelling, entailing a lot of information (DGP, intervention distribution)
- Note: *"Garbage in, Garbage out"*
- computational advantage casting causal model as system of assignments 

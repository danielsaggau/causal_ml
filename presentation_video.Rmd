...
- Focus on acyclical structures (DAG)
...
* ...have very limited knowledge of your actual underlying causal structure 
...
* ... have a good understanding of underlying latent factors 
* ... have a lot of information on your underlying relationship in your data 
* ... are dealing with high stake settings 
* ... want to simulate different interventions before implementing them

$\rightarrow$ you should probably go for a SCM 

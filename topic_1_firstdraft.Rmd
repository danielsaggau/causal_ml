...
Causal inference introduced tools that combine combine different sources of knowledge. 
We can e.g. include theoretical knowledge [@morgan_winship_2014] and observational knowledge with structural causal models.
...
SEMs are popular in fields like economics, psychology and sociology (Pearl 2009).
...
Pearl focuses on three layers: association, intervention and counterfactuals. 
...
Here we can use Pearls (2009) do-calculus.
...
Henceforth, they cannot create counterfactuals (Pearl 2009).

Another issue in this paper is understanding the relationship of time and causality.
SCMs make the assumption that causal relationships hold over time (Peters et al. 2017).
...
Differential equations model time on a more mechanic manner (Mooij et al. 2013).

Existing literature has provided an excellent introduction to SCMs and BCNs. 
Pearl (2009) provided a comprehensive introduction into this topic with his book 'Causality'.
His work addressed misconceptions in social sciences, causality and statistics. 
Peters et al. (2017) address the relationship of causality, physical sciences, and causal inference.
They also look at causal inference for observational data.
...
This paper combines these contributions. 
The aim of this paper is to summarise SCMs and it's intersection with social sciences, physics, and machine learning.
...
Trygve Haavelmo (1944) provided a framework for Economics in his paper 'The Probability Approach in Econometrics'.
This paper introduced a new of level of sophistication to the discipline of Econometrics. 
Haavelmo won the Nobel Memorial Prize in Economic Science in 1989 for his work on this issue. 

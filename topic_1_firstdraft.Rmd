...
These methods depend on association alone.
Associational methods neglect information on changes in our root nodes. 
Root nodes are nodes that are not caused by any other variable.

...
Summarized, *'they are simulators that generate a distribution based noise variables (independent) and a unique joint distribution...'* [@hardtrecht].
- noise variables helo generate joint distribution [@barocas].
...
The potential outcomes are conditionally independent of treatment given some set of deconfounding variables. [@hardtrecht]
(perfect RCT)

...
The aim of this paper is to provide an intuitive understanding of different concepts within causality using manifold elements from core literature on causality. 
...
Recently, reserach has fairness has adopted various concepts and developed new characterisitics such as counterfactual fairness [@kusner_counterfactual_2018].

...
Section 2 introduces the assumptions in causal modelling. Further, section 2 discusses different assumptions in causal modelling. Section 3
Section 4 addresses Pearls Causal Hierachy.
Section 5 provides a brief introduction into graphical models.
Section 6 focuses on the intersection of SCMs and the perception of time. 
...
These equations are asymmetric, because they are not bi-directional.
...
A structural causal model contains an underlying graphical model [@hardtrecht]. 

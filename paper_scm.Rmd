...
The aim of this paper is to provide an example based, inutitive understanding of different concepts within causality using manifold elements from core literature on causality. 

The rest of the paper is structured as follows:
Section 2 introduces the assumptions in causal modelling.
Section 3 addresses Pearls Causal Hierachy.
Section 4 focuses on the intersection of SCMs and the perception of time. 
Section 5 concludes. 
...
The hierarchy of causation contains (see table 1) three levels. 
The higher the method on the hierarchy, the more information the method requires.
